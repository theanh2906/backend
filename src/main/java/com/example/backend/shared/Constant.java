...
public class Constant {
    ...
    public static final String[] CROSS_ORIGIN_ALLOW_LIST = new String[]{"http://localhost:8081", "http://localhost:4200", "https://benna.vercel.app", "https://theanh2906.ddns.net"};
